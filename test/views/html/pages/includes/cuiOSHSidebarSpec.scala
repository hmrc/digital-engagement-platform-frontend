...
class cuiOSHSidebarSpec extends ViewSpecBase with Matchers with WordSpecLike {
  ...
  "behave like an include" when {
    ...
    "show the sidebar chatbot cannot paragraph" in {
      ...
      assertEqualsValue(doc, "#chatbot-cannot", "If it cannot help you, you can ask to transfer " +
        "to an HMRC adviser by typing ‘adviser’. Advisers work Monday to Friday, 8am to 7:30pm, Saturday, 8 to 4pm and do not work Sundays or bank holidays.")
    }
  }
}
