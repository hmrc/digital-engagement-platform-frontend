...
class DAv4WMRNICreditViewSpec extends ChatViewBehaviours with Matchers with AnyWordSpecLike {

  private val view = app.injector.instanceOf[DAv4WMRNICreditView]

  private def createView: () => HtmlFormat.Appendable = () => view()(fakeRequest, messages)

  "WMRNICredit DAv4 webchat view" must {
    ...
    behave like normalPage(
      ...
      "National Insurance credit application webchat",
      "contact HMRC",
      returnUrl,
       Some(Seq(
        "Opening times:",
