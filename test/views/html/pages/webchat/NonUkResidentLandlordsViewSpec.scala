...
class NonUkResidentLandlordsViewSpec extends ChatViewBehaviours with Matchers with WordSpecLike {
  ...
  "NonUk Resident Landlords view" must {
    ...
    behave like normalPage(
      createView(false),
      "Ask HMRC",
      "Non-UK resident landlords: webchat - GOV.UK",
  ...
  "NonUk Resident Entertainers view" must {
    ...
    behave like normalPage(
      createView(true),
      "Ask HMRC",
      "Non-UK resident entertainers: webchat - GOV.UK",
