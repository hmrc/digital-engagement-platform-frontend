...
import views.html.webchat.CharitiesCommunityAmateurSportsView

class CharitiesCommunityAmateurSportsViewSpec extends ChatViewBehaviours with Matchers with AnyWordSpecLike {
