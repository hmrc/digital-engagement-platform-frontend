...
import views.html.webchat.CorporationTaxEnquiriesView

class CorporationTaxEnquiriesViewSpec extends ChatViewBehaviours with Matchers with AnyWordSpecLike {
  ...
  "Corporation Tax Enquiries view" must {
    ...
    behave like normalPage(
      createView(),
      "Ask HMRC",
      "Corporation Tax: webchat - GOV.UK",
